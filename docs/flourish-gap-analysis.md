...
> 2026-07-29 注记：本文保留为早期差距调研。当前代码已经完成模板注册表、每家族 renderer、字段角色绑定、模板校验、设置组动态显示、示例数据和行为回归测试。最新阶段判断见 `docs/project-stage-and-control.md`，布局调整方案见 `docs/layout-redesign-plan.md`。
